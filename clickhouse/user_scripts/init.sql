...
CREATE TABLE IF NOT EXISTS raw.cdc_order_payments (
    ...
    `before.payment_value.scale` Nullable(UInt16),
    `before.payment_value.value` Nullable(String),
    `before.created_at` Nullable(DateTime64(6,'Asia/Jakarta')),
    `before.updated_at` Nullable(DateTime64(6,'Asia/Jakarta')),
    `before.deleted_at` Nullable(DateTime64(6,'Asia/Jakarta')),
    ...
    `after.payment_installments` Nullable(UInt16),
    `after.payment_value.scale` Nullable(UInt16),
    `after.payment_value.value` Nullable(String),
    `after.created_at` Nullable(DateTime64(6,'Asia/Jakarta')),
    `after.updated_at` Nullable(DateTime64(6,'Asia/Jakarta')),
    `after.deleted_at` Nullable(DateTime64(6,'Asia/Jakarta')),
...
CREATE MATERIALIZED VIEW raw.mv_order_payments (
    ...
    `payment_installments` Nullable(UInt16),
    `payment_value` Nullable(Decimal(19,4)),
    `created_at` Nullable(DateTime64(6,'Asia/Jakarta')),
    `updated_at` Nullable(DateTime64(6,'Asia/Jakarta')),
    `version` UInt64,
    `deleted` UInt8
...
SELECT 
    ...
    if(op = 'd', 
        bigDecimalDecode(`before.payment_value.value`,before.payment_value.scale),
        bigDecimalDecode(`after.payment_value.value`,after.payment_value.scale)
        ) AS payment_value,
    if(op = 'd', `before.created_at`, `after.created_at`) AS created_at,
    if(op = 'd', toDateTime64(ts_ms / 1000.0, 6, 'Asia/Jakarta'), `after.updated_at`) AS updated_at,
    source.lsn AS version,
...
CREATE TABLE IF NOT EXISTS raw.cdc_order_items (
    ...
    `before.price.scale` Nullable(UInt16),
    `before.price.value` Nullable(String),
    `before.freight_value.scale` Nullable(UInt16),
    `before.freight_value.value` Nullable(String),
    `before.created_at` Nullable(DateTime64(6,'Asia/Jakarta')),
    `before.updated_at` Nullable(DateTime64(6,'Asia/Jakarta')),
    `before.deleted_at` Nullable(DateTime64(6,'Asia/Jakarta')),
    ...
    `after.price.scale` Nullable(UInt16),
    `after.price.value` Nullable(String),
    `after.freight_value.scale` Nullable(UInt16),
    `after.freight_value.value` Nullable(String),
    `after.created_at` Nullable(DateTime64(6,'Asia/Jakarta')),
    `after.updated_at` Nullable(DateTime64(6,'Asia/Jakarta')),
    `after.deleted_at` Nullable(DateTime64(6,'Asia/Jakarta')),
...
CREATE MATERIALIZED VIEW raw.mv_order_items (
    ...
    `freight_value` Nullable(Decimal(19,4)),
    `created_at` Nullable(DateTime64(6,'Asia/Jakarta')),
    `updated_at` Nullable(DateTime64(6,'Asia/Jakarta')),
    `version` UInt64,
    `deleted` UInt8
...
SELECT 
    ...
    if(op = 'd', 
        ...
        bigDecimalDecode(`after.freight_value.value`,after.freight_value.scale)
        ) AS freight_value,
    if(op = 'd', `before.created_at`, `after.created_at`) AS created_at,
    if(op = 'd', toDateTime64(ts_ms / 1000.0, 6, 'Asia/Jakarta'), `after.updated_at`) AS updated_at,
    source.lsn AS version,
